    ...
    <div class="space-y-6">
        <x-filament::section>
            ...
            <dl class="grid grid-cols-1 gap-4 md:grid-cols-2 2xl:grid-cols-3">
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">NIT (Carpeta física / Sección Cédula del Establecimiento/NIT)</dt>
        ...
        <x-filament::section>
            ...
            <dl class="grid grid-cols-1 gap-4 md:grid-cols-2 2xl:grid-cols-3">
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Número de documento (Carpeta física / Sección Cédula del Establecimiento/CC Propietario)</dt>
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Número de documento (Carpeta física / Sección Cédula del Establecimiento/CC Rep. Leg.)</dt>
