...
class SanitationBuildings extends Page
{
    ...
    protected static string $view = 'filament.pages.tenancy.sanitation-buildings';public $teamId;
    protected static ?string $slug = 'saneamiento-de-edificaciones';
    
    public $section = 'Saneamiento de edificaciones';    // grouped settings ready for rendering;
