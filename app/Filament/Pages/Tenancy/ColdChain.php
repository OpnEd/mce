...
class ColdChain extends Page
{
    //protected static ?string $cluster = InspectionSurveillanceControlAudit::class;

    protected static ?int $navigationSort = 37;
    protected static ?string $navigationLabel = '16. Cadena de frío';
    protected static ?string $navigationGroup = 'Secretaría de Salud';

    protected static string $view = 'filament.pages.tenancy.cold-chain';
    protected static ?string $slug = 'cadena-de-frio';
    public $teamId;
    public $section = ' Proceso de Manejo de Medicamentos Cadena de Frío';    // grouped settings ready for rendering;
